...
class HrAttendance(models.Model):
    ...
    department_id = fields.Many2one('hr.department', string="Department", related="employee_id.department_id",
        readonly=True)
    check_in = fields.Datetime(string="Check In", default=fields.Datetime.now, required=True,tracking=1,readonly=True)
    check_out = fields.Datetime(string="Check Out",tracking=1,readonly=True)
